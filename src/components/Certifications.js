        ...
        <div className='certifications-body'>
            ...
            <div>
                ...
                <div className='certifications-sec'>
                    ...
                    <a href="https://www.coursera.org/account/accomplishments/verify/BDUYBUD7GAHJ" target="_blank" className='certifications-link'>
                ...
                <div className='certifications-sec'>
                    ...
                    <a href="https://www.coursera.org/account/accomplishments/verify/EUVTF5KXUZCR" target="_blank" className='certifications-link'>
                ...
                <div className='certifications-sec'>
                    ...
                    <a href="https://learn.microsoft.com/api/credentials/share/en-us/SRIKRISHNAKOWSHIKNALLIBOINA-2748/AF3666122E726FC5?sharingId=E4D94DDA8173860C" target="_blank" className='certifications-link'>
                ...
                <div className='certifications-sec'>
                    ...
                    <a href="https://www.coursera.org/account/accomplishments/verify/85XJN3XN3RSJ" target="_blank" className='certifications-link'>
